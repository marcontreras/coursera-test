...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Inmunidad.data';
    var REMOTE_PACKAGE_BASE = 'Inmunidad.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8884274;
      var PACKAGE_UUID = '83d600e0-0383-4eee-b280-68e8f8139edf';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 6014927, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(6014927, 6014946, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(6014946, 6015189, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(6015189, 7981677, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7981677, 8856649, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8856649, 8884274, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Inmunidad.data');

    };
    Module['addRunDependency']('datafile_Inmunidad.data');
